...
function App() {
  ...
  async function refresh(userId = session?.user.id) {
    ...
    setTasks(taskGroups); setJobs(loadedJobs); setEntries((entryData ?? []) as TimeEntry[]); setActive(loadedActive);
